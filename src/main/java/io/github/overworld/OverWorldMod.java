...
public class OverWorldMod implements ModInitializer {
  ...
  public static final InfernalReliquary INFERNAL_RELIQUARY =
      new InfernalReliquary(null);

  @Override
  public void onInitialize() {
    Registry.register(Registries.ITEM,
                      new Identifier(MOD_ID, "infernal_reliquary"),
                      INFERNAL_RELIQUARY);

    ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS)
        .register(content -> { content.add(INFERNAL_RELIQUARY); });
  }
}
